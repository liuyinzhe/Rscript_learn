...
par(ask=F)
setwd('D:\\Rscript\\volcano_gene\\draw\\batch1')
...
data_pre <- read.csv('genename.input.xls',sep='\t',comment.char = "",header = TRUE,stringsAsFactors = FALSE)
# 删除 pval列 为Na的行
...
#R语言火山图怎么显示差异显著前20个GENE名称 火山图 r语言
#https://blog.51cto.com/u_12902/6527546
