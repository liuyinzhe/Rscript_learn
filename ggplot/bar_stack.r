library(ggplot2)
setwd("/data/home/liuyinzhe/project/RNA_seq/RS22YWTJZY61/new/04.featurecounts/fpkm")

data = read.table("all.fpkm_plot2.tsv",header=T,sep="\t",check.names=F) 
...
ggsave('gene_fpkm_bar_stacked.png',,plot=P, height=12, width=12, units="in",dpi=600)
