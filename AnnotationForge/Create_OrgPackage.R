...
emapper <- read.table("Sm.annotations",header = TRUE,sep = "\t",quote = "",stringsAsFactor = FALSE)
...
# https://www.genome.jp/kegg-bin/get_htext?ko00001 ->download json
...
makeOrgPackage(gene_info=gene_info,
               ...
               version="1.1.0", 
               maintainer="lyz <lsylkane@sina.com>", 
               author="lyz <lsylkane@sina.com>", 
               outputDir="D:\\Rscript\\annotations",
               tax_id=tax_id,  
               genus=genus, 
               species=species,
               goTable="go",
